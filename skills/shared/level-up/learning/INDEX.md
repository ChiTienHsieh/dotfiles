...
| --- | --- | --- | --- | --- |
| Personal eval set preflight | mastered | 私房賽道（KartRider 風味）類比首航成功。七關決策全拍板（rubric replay/混合存放/分層打分/判例庫/私有 submodule/圈速牆/手動鑰匙/順檢養護）；user 兩度自提加碼案、自行點出 judge alignment 問題。capability vs preference 二分法已內化為 moat 論。出貨 codex/notes/personal-eval-set-plan.md。 | 2026-07-19 | topics/personal-eval-set.md |
