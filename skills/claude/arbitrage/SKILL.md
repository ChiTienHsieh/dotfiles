---
name: arbitrage
description: "Use in Claude Code when implementation work is being planned or delegated, to keep Claude focused on judgment while routing code-writing work to observable Codex sessions through cmux."
---
...
| Bulk code edits and test-driven implementation | Codex in cmux | Use an observable surface. |
...
3. Start or reuse a cmux terminal surface with interactive Codex.
...
- Prefer the `cmux-orchestrator` skill and its `drive_codex.sh` helper when
  available.
...
2. Codex implements in a visible cmux surface.
